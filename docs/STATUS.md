...
| Linux | None | Browser interface preview; native execution unsupported |
...
The owner-approved reporting contact is coipoddev@gmail.com. Public release remains subject to the checklist in [release readiness](release/READINESS.md). Historical Korean design and validation records are retained as archives and are not current support promises.
